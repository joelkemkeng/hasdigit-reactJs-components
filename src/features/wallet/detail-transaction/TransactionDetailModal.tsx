...
export const TransactionDetailModal: React.FC<TransactionDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-start sm:items-center justify-center z-50 p-0 sm:p-6 overflow-y-auto">
      <div className="w-full max-w-5xl bg-white dark:bg-gray-900 rounded-none sm:rounded-2xl overflow-hidden shadow-2xl animate-fadeIn my-0 sm:my-6 min-h-screen sm:min-h-0">
